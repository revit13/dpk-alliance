...
from data_processing.examples.noop.python import NOOP4TransformConfiguration


logger = get_logger(__name__)


class NOOP4SparkTransformConfiguration(SparkTransformRuntimeConfiguration):
    """
...
if __name__ == "__main__":
    # create launcher
    launcher = SparkTransformLauncher(runtime_config=NOOP4SparkTransformConfiguration())
