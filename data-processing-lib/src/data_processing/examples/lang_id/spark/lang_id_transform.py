...
from data_processing.examples.lang_id.python import LangIdentificationTransformConfiguration


logger = get_logger(__name__)


class LangIdentificationSparkTransformConfiguration(SparkTransformRuntimeConfiguration):
    """
...
if __name__ == "__main__":
    # create launcher
    launcher = SparkTransformLauncher(runtime_config=LangIdentificationSparkTransformConfiguration())
